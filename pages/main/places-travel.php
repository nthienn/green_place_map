...
$sql_places = "SELECT * FROM places,place_types WHERE places.id_place_type=place_types.id_place_type AND places.id_place_type=3 ORDER BY places.star DESC LIMIT $begin,50";
