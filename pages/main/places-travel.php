...
$sql_places = "SELECT * FROM places,place_types WHERE places.id_place_type=place_types.id_place_type AND places.id_place_type=3 ORDER BY places.star DESC LIMIT $begin,20";
...
<section>
    <div class="category">
        <ul class="category-list">
            ...
            <li class="category-item">
                <a href="index.php?action=diadiemxanh&query=travel" class="category-link active">
